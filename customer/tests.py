...
class customerTest(LiveServerTestCase):
    ...
    def test1_form(self):
        ...
        self.fillFieldsAndClick("AB","Pelte","emre@emre.com","905375016950","lkhjslkhsdfsdfsdfsdfsdfsdfsdfsdfsdf lsdgjsgj")
        ...
        self.actualResultStep2["namevalidation"] = self.browser.find_element(By.XPATH, "//span[contains(@class, 'text-danger')]").text
        self.assertEqual(
            self.expected["step2"],
        ...
        self.fillFieldsAndClick("Emre", "535fgf", "emre@emre.com", "905375016950",
                                "lkhjslkhsdfsdfsdfsdfsdfsdfsdfsdfsdf lsdgjsgj")
        self.actualResultStep3["surnamevalidation"] = self.browser.find_element(By.XPATH, "//span[contains(@class, 'text-danger')]").text
        self.assertEqual(
            self.expected["step3"],
        ...
        self.actualResultStep8 = dict(
            ...
            address=self.browser.find_element(By.XPATH, "//td[contains(text(), 'lkhjslkhsdfsdfsdfsdfsdfsdfsdfsdfsdf lsdgjsgj')]").text,
        )
    ...
    def test2_Update_customer(self):
        self.setup()
    ...
    def test3_Delete_Customer(self):
        self.setup()
